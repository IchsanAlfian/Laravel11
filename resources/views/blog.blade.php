        ...
        <a href="/blog/{{ $post['slug'] }}" class="font-medium text-blue-500 hover:underline">Read More &raquo;</a>
                    ...
                    <article
                        ...
                        <div class="flex justify-between items-center">
                            <a href="/blog?author={{ $post->author->username}}"><div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <a href="/blog" class="block text-blue-600 hover:underline">&laquo; Back To All Post</a>
                    </div>
